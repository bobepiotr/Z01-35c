...
class ChatWindow:
    def __init__(self, cli_name, cli_id, rec_name):
        ...
        self.frame_message = None  # frame that contains msg entry and send button
        self.message_entry = None  # Entry for messages
        self.receiver_name_label = None  # Label with receiver name
        self.root = tk.Tk()
    ...
    def init_user_list(self):
        ...
        self.get_all_users()  # <==========================requesting user list from server
        self.sort_user_list()   # <=============================sorting list of users

        self.update_user_list()   # <==============================updating user list
